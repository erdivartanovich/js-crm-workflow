...
const basePath = '../../../src'
const CustomFieldValueService = require(basePath + '/Services/CustomField/CustomFieldValueService')
var tracker = require('mock-knex').getTracker()

const testClass = new CustomFieldValueService()
...
describe('CustomFieldValueService', () => {
    ...
    describe('#add()' , () => {
        it('should return a valid query', (done) => {
            const query = 'insert into `' + tableName + '` (`created_at`, `field_id`, `id`, `updated_at`, `value`, `value_id`) values (?, ?, ?, ?, ?, ?)'
            const mockObject = {id: 4, field_id: 3, value: 'afternoon'}
